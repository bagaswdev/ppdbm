                    ...
                    <div class="card-body scroll">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                @if ($data && $data->relasi_ke_table_data_grup_wa && $data->relasi_ke_table_data_grup_wa->tb_data_grup_wa_file)
                                    <img src="{{ $data->relasi_ke_table_data_grup_wa->tb_data_grup_wa_file }}"
                                        alt=""
                                        style="display: block; max-height: 50%; max-width: 100%; margin: auto;">
                                @else
                                    <p>-</p>
                        ...
                        <form action="{{ route('simpanDataVerifikasiFotoWAKIP') }}" method="POST" class="forms-sample">
                                            ...
                                            <div class="form-check mb-3">
                                                @if ($data && $data->foto && $data->foto->tb_data_user_verifikator_id)
                                                    ...
                                                    <label class="form-check-label" for="exampleCheck1">Sudah Di
                                                        ...
                                                        Oleh</label>
                                                    <span
                                                        class="badge rounded-pill bg-danger">{{ $data->foto->fk_dari_table_data_user_verifikator->tb_data_user_verifikator_nama }}</span>
                                                @elseif ($data && $data->foto && $data->foto->tb_data_user_verifikator_id === null)
                                                    <input type="checkbox" class="form-check-input" id="exampleCheck1"
                                ...
                                <div class="d-flex flex-column">
                                    <div class="row align-items-center">
                                        ...
                                        @elseif ($data && $data->foto && $data->foto->tb_data_foto_alasan === null)
                                            <label for="tb_data_foto_alasan" class="col-md-3 col-form-label">Alasan
                                                :</label>
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex flex-column">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 mt-2">
                                            ...
                                            <div class="form-check mb-3">
                                                @if ($data && $data->relasi_ke_table_data_grup_wa && $data->relasi_ke_table_data_grup_wa->tb_data_user_verifikator_id)
                                                    ...
                                                    <label class="form-check-label"
                                                        for="tb_data_user_verifikator_id_verifikasi_grup_wa">Sudah Di
                                                        Verifikasi
                                                        Oleh</label>
                                                    <span
                                                        class="badge rounded-pill bg-danger">{{ $data->relasi_ke_table_data_grup_wa->fk_dari_table_data_user_verifikator->tb_data_user_verifikator_nama }}</span>
                                                @elseif (
                                                    $data &&
                                                        $data->relasi_ke_table_data_grup_wa &&
                                    ...
                                    <div class="col-md-9 mt-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            @if ($data->relasi_ke_table_data_grup_wa->tb_data_grup_wa_status == '0')
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" class="form-check-input" value="0"
                                                        name="tb_data_grup_wa_status"
                                                        id="tb_data_grup_wa_status_tidak_lolos" checked>
                                                    <label class="form-check-label"
                                                        for="tb_data_grup_wa_status_tidak_lolos">
                                                        TIDAK LOLOS
                                                    </label>
                                                </div>
                                            @elseif ($data->relasi_ke_table_data_grup_wa->tb_data_grup_wa_status == '1')
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" class="form-check-input" value="0"
                                                        name="tb_data_grup_wa_status"
                                                        id="tb_data_grup_wa_status_tidak_lolos">
                                                    <label class="form-check-label"
                                                        for="tb_data_grup_wa_status_tidak_lolos">
                                                        TIDAK LOLOS
                                                    </label>
                                ...
                                <div class="d-flex flex-column">
                                    <div class="row align-items-center">
                                        <!-- Tambahkan kelas align-items-center di sini -->
                                        @if ($data && $data->relasi_ke_table_data_grup_wa && $data->relasi_ke_table_data_grup_wa->tb_data_grup_wa_alasan)
                                            <label for="tb_data_grup_wa_alasan"
                                                class="col-md-3 col-form-label">Alasan:</label>
                                            <div class="col-md-9">
                                        ...
                                        @elseif (
                                            ...
                                            <label for="tb_data_grup_wa_alasan" class="col-md-3 col-form-label">Alasan
                                                :</label>
                                            <div class="col-md-9 mt-md-0 mt-2">
                                                <!-- Tambahkan kelas mt-md-0 di sini -->
                                                <input type="text" class="form-control" id="tb_data_grup_wa_alasan"
                            ...
                            @if ($data && $data->kip && $data->kip->tb_data_kip_file)
                                <div class="d-flex flex-column">
                                    <div class="d-flex flex-column">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 mt-2">
                                                ...
                                                <div class="form-check mb-3">
                                                    @if ($data && $data->kip && $data->kip->tb_data_user_verifikator_id)
                                                        <input type="checkbox" class="form-check-input" value="1"
                                                        ...
                                                        <label class="form-check-label"
                                                            ...
                                                            Oleh</label>
                                                        <span
                                                            class="badge rounded-pill bg-danger">{{ $data->kip->fk_dari_table_data_user_verifikator->tb_data_user_verifikator_nama }}</span>
                                                    @elseif ($data && $data->kip && $data->kip->tb_data_user_verifikator_id === null)
                                                        <input type="checkbox" class="form-check-input" value="1"
                                                            id="tb_data_user_verifikator_id_verifikasi_kip"
                                        ...
                                        <div class="col-md-9 mt-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                @if ($data->kip->tb_data_kip_status == '0')
                                                    <div class="form-check form-check-inline">
                                                        <input type="radio" class="form-check-input" value="1"
                                                            name="tb_data_kip_status" id="tb_data_kip_status_lolos">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input type="radio" class="form-check-input" value="0"
                                                            name="tb_data_kip_status" id="tb_data_kip_status_tidak_lolos"
                                                            checked>
                                                        <label class="form-check-label"
                                                            for="tb_data_kip_status_tidak_lolos">
                                                            TIDAK LOLOS
                                                        </label>
                                                    </div>
                                                @elseif ($data->kip->tb_data_kip_status == '1')
                                                    <div class="form-check form-check-inline">
                                                        <input type="radio" class="form-check-input" value="1"
                                                            name="tb_data_kip_status"
                                                            id="tb_data_foto_grup_wa_status_lolos" checked>
                                                        <label class="form-check-label"
                                                            for="tb_data_foto_grup_wa_status_lolos">
                                                            LOLOS
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="row align-items-center">
                                            <!-- Tambahkan kelas align-items-center di sini -->
                                            @if ($data && $data->kip && $data->kip->tb_data_kip_alasan)
                                                <label for="tb_data_kip_alasan"
                                                    class="col-md-3 col-form-label">Alasan:</label>
                                                <div class="col-md-9">
                                            ...
                                            @elseif ($data && $data->kip && $data->kip->tb_data_kip_alasan === null)
                                                <label for="tb_data_kip_alasan" class="col-md-3 col-form-label">Alasan
                                                    :</label>
                                                <div class="col-md-9 mt-md-0 mt-2">
                                                    <!-- Tambahkan kelas mt-md-0 di sini -->
