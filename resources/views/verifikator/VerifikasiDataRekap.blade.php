                    ...
                    <div class="d-flex flex-column">
                        <div class="row">
                            ...
                            <div class="d-flex align-items-center border-bottom py-3">
                                <div class="w-100">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="fw-normal text-body mb-1">Sekolah Asal : Malang</h6>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive mb-5">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <th>MATEMATIKA</th>
                                    <td><input type="number" id="nilai_mtk_kls5_smt1"></td>
                                    <td><input type="number" id="nilai_mtk_kls5_smt2"></td>
                                    <td><input type="number" id="nilai_mtk_kls6_smt1"></td>
                                </tr>
                                <tr>
                                    <th>IPA/IPAS</th>
                                    <td><input type="number" id="nilai_ipa_kls5_smt1"></td>
                                    <td><input type="number" id="nilai_ipa_kls5_smt2"></td>
                                    <td><input type="number" id="nilai_ipa_kls6_smt1"></td>
                                </tr>
                                <tr>
                                    <th>B. INDONESIA</th>
                                    <td><input type="number" id="nilai_bi_kls5_smt1"></td>
                                    <td><input type="number" id="nilai_bi_kls5_smt2"></td>
                                    <td><input type="number" id="nilai_bi_kls6_smt1"></td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
