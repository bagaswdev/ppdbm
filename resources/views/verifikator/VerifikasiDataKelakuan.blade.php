            ...
            <div class="card-body scroll">
                ...
                <div class="d-flex flex-column">
                    <div class="d-flex flex-column">
                        <div class="row">
                            ...
                            <div class="d-flex align-items-center border-bottom py-3">
                                <div class="w-100">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="fw-normal text-body mb-1">Alamat : Malang</h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center border-bottom py-3">
                                <div class="w-100">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="fw-normal text-body mb-1">Sekolah asal : </h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center border-bottom py-3 mb-4">
                                <div class="w-100">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="fw-normal text-body mb-1">NISN : 089999999999</h6>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="d-flex flex-column my-3">
                        <div class="row align-items-center">
                            <!-- Tambahkan kelas align-items-center di sini -->
                            <label for="tb_data_ayah_kandung_status" class="col-md-3 col-form-label">Sekolah Asal
                            </label>
                            <div class="col-md-9 mt-md-0 mt-2">
                                <!-- Tambahkan kelas mt-md-0 di sini -->
                                <input type="text" class="form-control" id="tb_data_ibu_kandung_nama"
