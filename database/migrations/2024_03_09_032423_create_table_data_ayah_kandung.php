...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('table_data_ayah_kandung', function (Blueprint $table) {
            ...
            $table->string('tb_data_ayah_kandung_nik', 20)->nullable()->default(null);
            $table->string('tb_data_ayah_kandung_no_kk', 20)->nullable()->default(null);
            $table->string('tb_data_ayah_kandung_status')->nullable()->default(null);
            $table->string('tb_data_ayah_kandung_hubungan')->nullable()->default(null);
            $table->timestamps();
        });
    }
